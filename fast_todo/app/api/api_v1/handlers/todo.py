...
async def list(current_user: User = Depends(get_current_user)):  # Verifica se está autenticado
...
@todo_router.put('/{todo_id}', summary='Atualiza Nota', response_model=Todo)
